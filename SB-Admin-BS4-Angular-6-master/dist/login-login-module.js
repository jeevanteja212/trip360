...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onLoggedin = function () {
        ...
        if (!this.userName) {
            ...
            this.userService.getIpCliente().then(function (ip) {
                debugger;
                _this.userService.getAuthenticate(_this.userName, _this.password, ip['ip']).subscribe(function (x) {
                    // this.router.navigate(['/home'])
                    if (x) {
                        if (x.length > 1) {
                            _this.LoginModel = JSON.parse(x[0]);
                            if (_this.LoginModel.TokenId) {
                                localStorage.setItem('UserDetails', JSON.stringify(x[1]));
                                localStorage.setItem('TokenId', _this.LoginModel.TokenId);
    ...
    LoginComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_shared_services_authentication_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _shared_services_authentication_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]])
    ], LoginComponent);
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getAuthenticate = function (userName, password, ip) {
        var parms = {
        ...
        var body = parms;
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].serviceUrl + '/postDataService', body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
    ...
    UserService.prototype.getIpCliente = function () {
        debugger;
        return this.http.get('http://api.ipify.org/?format=json').toPromise().then(function (x) { return x; });
    };
